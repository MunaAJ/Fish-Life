...
* its size, and the direction in which it is moving (UP, DOWN, LEFT, or RIGHT).*                                                               
* <p>   																	   *                                                              
...
/******************************************************************************* 
* copy constructor -- just copies the fields								   *
*******************************************************************************/
...
*******************************************************************************/
	...
	public String toString() {
		return "row: " + row + "col: " + col + "size: " + "direction: " + 
				direction;
	}
...
* set to LEFT.  If 3, set to RIGHT.  IMPORTANT:  DO NOT SET THE DIRECTION      *
* TO THE VALUES 0, 1, 2, OR 3 -- directions must be set using the static       *
* constants (UP, DOWN, LEFT, RIGHT).										   *
*******************************************************************************/
